...
import { TI_CONFIG, TR_CONFIG, donutTags, boxByOrder, resolveColor, TMConfig, TMPoint } from "@/data/talentMappingShared";
...
function Panel({ config, points, initialBox = null }: { config: TMConfig; points: TMPoint[]; initialBox?: number | null }) {
...
export default function TalentMappingClient({
  ...
  return (
    <div style={{ fontFamily: FONT }}>
      ...
      <Panel key={tab} config={config} points={points} initialBox={initialBox} />
      </div>
    </div>
  );
}
