...
type UserRole = "hr" | "manager";

const MANAGER_EXCLUDED_CARDS = new Set([
  "committee-readiness",
...
export default function Home() {
  ...
  function renderCard(id: string) {
    switch (id) {
      ...
      />;
      case "profile-completion":     return <ProfileCompletion employees={isManager ? managerTeam : undefined} />;
      ...
      case "data-health-indicator":  return <DataHealthIndicatorCard employees={isManager ? managerTeam : undefined} />;
      case "quick-profile-access":   return <QuickProfileAccessCard employees={isManager ? managerTeam : undefined} />;
      case "overall-score":          return <OverallScoreCard />;
      case "sync-status":            return <SyncStatusCard />;
      case "activity-log":           return <ActivityLogCard />;
          ...
          <div className="px-4 pb-8">
            <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 16, minWidth: 0 }}>
                ...
                {profileCompletionEnabled && <ProfileCompletion employees={isManager ? managerTeam : undefined} />}
