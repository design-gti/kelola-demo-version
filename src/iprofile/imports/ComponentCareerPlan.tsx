import svgPaths from "./svg-t63ewyn5pn";
...
function Frame12() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <button className="block cursor-pointer overflow-clip relative shrink-0 size-[20px]" data-name="chevron-up">
...
export default function ComponentCareerPlan() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative size-full" data-name="Component Career plan">
      <Frame13 />
      <Frame11 />
    </div>
  );
