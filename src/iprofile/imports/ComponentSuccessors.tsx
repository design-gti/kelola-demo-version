import svgPaths from "./svg-c6yt3d5wws";
const imgComponentSuccessors = "/iprofile-assets/7d155afcea4f2b1e6b32eb88a344313d97b8f6a2.png";

export default function ComponentSuccessors() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative size-full" data-name="Component successors">
      ...
      <div className="bg-[#f8f9fa] relative rounded-[8px] shrink-0 w-full">
        ...
        <div className="content-stretch flex flex-col gap-[8px] items-start p-[8px] relative w-full">
          <div className="content-stretch flex gap-[8px] h-[30px] items-center relative rounded-[8px] shrink-0 w-full">
            <div className="bg-white overflow-clip relative rounded-[15px] shadow-[1px_1px_8px_0px_rgba(0,0,0,0.2)] shrink-0 size-[30px]">
              <div className="absolute left-px size-[31px] top-0" data-name="portrait-successful-business-woman-using-digital-tablet-front-modern-office 2">
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                  <img alt="" className="absolute h-[239.1%] left-[-51.94%] max-w-none top-[-24.12%] w-[159.36%]" src={imgComponentSuccessors} />
                </div>
              </div>
            </div>
                ...
                <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Vector">
                  <div className="absolute inset-[-15%_-7.5%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.5 6.5">
                      <path d={svgPaths.p259324a0} id="Vector" stroke="var(--stroke-0, #58595B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                    </svg>
                  </div>
                </div>
              </div>
          ...
          <div className="content-stretch flex gap-[8px] h-[35px] items-start relative shrink-0 w-[298px]">
            <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[28px]" data-name="button">
              ...
              <div className="flex flex-row items-center justify-center size-full">
                <div className="content-stretch flex gap-[8px] items-center justify-center px-[12px] py-[8px] relative w-full">
                  <p className="font-['Avenir:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#016699] text-[14px]">Create IDP</p>
                </div>
              </div>
            </div>
            <div className="bg-[#016699] flex-[1_0_0] min-h-px min-w-px relative rounded-[28px]" data-name="button">
              <div className="flex flex-row items-center justify-center size-full">
                <div className="content-stretch flex gap-[8px] items-center justify-center px-[12px] py-[8px] relative w-full">
                  <p className="font-['Avenir:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white">See IDP Progress</p>
                </div>
              </div>
            </div>
          </div>
