    ...
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      ...
      >
        <div className="absolute bottom-1/4 left-[20.83%] right-[20.83%] top-1/4" data-name="Vector">
          <div className="absolute inset-[-9.38%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.8333 9.5">
              <path d={svgPaths.p33ce8620} id="Vector" stroke="var(--stroke-0, #016699)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
      </button>
      <div className="content-stretch flex gap-[5px] items-center relative shrink-0" data-name="Breadcrumbs">
        <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#58595b] text-[12px] whitespace-nowrap">
          <p className="leading-[normal]">Individual Development Plan</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#495057] text-[12px] w-[118px]">
        <p className="leading-[normal] whitespace-pre-wrap">Developed Aspects</p>
      </div>
      <Frame37 />
    </div>
  );
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[16px] items-center leading-[0] relative shrink-0 text-[#495057] text-[12px] w-full">
      <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center not-italic relative shrink-0 w-[118px]">
        <p className="leading-[normal] whitespace-pre-wrap">Period</p>
      </div>
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center relative shrink-0 whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">: Dec 5, 2024 - Mar 11, 2025</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[18px] items-center min-h-px min-w-px relative">
      <Frame1 />
    </div>
  );
}
...
function TeamCard() {
  return (
    <div className="relative shrink-0 w-full" data-name="Team Card">
      <div className="content-stretch flex gap-[10px] items-start overflow-clip pt-[12px] relative rounded-[inherit] w-full">
        <Frame4 />
        <Frame5 />
      </div>
...
function Frame33() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Avenir:Heavy',sans-serif] h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#495057] text-[12px] w-[504px]">
        <p className="leading-[normal] whitespace-pre-wrap">Development Goals</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#495057] text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre-wrap">Menjadi individu yang konsisten menjaga integritas dalam setiap keputusan</p>
      </div>
    </div>
  );
}
...
function Monitoring() {
  return (
    <div className="bg-[#f8f9fa] relative rounded-[8px] shrink-0 w-full" data-name="Monitoring">
...
function Frame34() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Avenir:Heavy',sans-serif] h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#495057] text-[12px] w-[504px]">
        <p className="leading-[normal] whitespace-pre-wrap">IDP Program</p>
      </div>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#495057] text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre-wrap">Mengembangkan kemampuan mengambil keputusan strategis dalam situasi kompleks dan memimpin tim lintas fungsi untuk mencapai tujuan bersama</p>
      </div>
      <Frame12 />
    </div>
  );
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[42px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#495057] text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre-wrap">Sesi mentoring dengan leader/senior yang dikenal berintegritas tinggi</p>
      </div>
      <Frame9 />
    </div>
  );
...
function Component() {
  return (
    <div className="bg-[#f8f9fa] relative rounded-[8px] shrink-0 w-full" data-name="Component 95">
      <div className="content-stretch flex flex-col gap-[4px] items-start p-[16px] relative w-full">
        <Frame34 />
        <Frame36 />
      </div>
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#495057] text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre-wrap">Notes ini adalah notes saat create IDP</p>
      </div>
    </div>
  );
}
...
function Component1() {
  return (
    <div className="bg-[#f8f9fa] relative rounded-[8px] shrink-0 w-full" data-name="Component 96">
      <div className="content-stretch flex flex-col gap-[4px] items-start p-[16px] relative w-full">
        <Frame35 />
        <ActionPlan1 />
      </div>
    ...
    <div className="bg-white h-[48px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="flex-[1_0_0] font-['Open_Sans:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#495057] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
  ...
  return (
    <div className="bg-white h-[48px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="flex-[1_0_0] font-['Open_Sans:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#495057] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            Mendapat nilai “Sangat Baik” dalam evaluasi integritas oleh atasan
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white h-[48px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="flex-[1_0_0] font-['Open_Sans:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#495057] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            Dipilih kembali untuk proyek yang membutuhkan kepercayaan tinggi atau terpilih menjadi role model integritas dalam tim oleh HR
          </p>
        </div>
      </div>
    </div>
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <div className="bg-[#f8f9fa] relative shrink-0 w-full" data-name="Title cell">
        <div aria-hidden="true" className="absolute border-[#dee2e6] border-b border-solid inset-[0_0_-0.5px_0] pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[12px] items-center justify-center px-[12px] py-[8px] relative w-full">
            <p className="flex-[1_0_0] font-['Avenir:Heavy',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#495057] text-[14px] whitespace-pre-wrap">Success Measures</p>
          </div>
        </div>
      </div>
      <Frame />
    ...
    <div className="bg-white h-[48px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative size-full">
          <p className="flex-[1_0_0] font-['Open_Sans:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px relative text-[#495057] text-[12px] whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            06 juli 2025
          </p>
          <div className="overflow-clip relative shrink-0 size-[20px]" data-name="calendar-event">
            <div className="absolute inset-[12.5%_16.67%]" data-name="Vector">
              <div className="absolute inset-[-5%_-5.63%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.8333 16.5">
                  <path d={svgPaths.p3caca680} id="Vector" stroke="var(--stroke-0, #ADB5BD)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                </svg>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[162px]">
      <div className="bg-[#f8f9fa] relative shrink-0 w-full" data-name="Title cell">
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[12px] items-center justify-center px-[12px] py-[8px] relative w-full">
            <p className="flex-[1_0_0] font-['Avenir:Heavy',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#495057] text-[14px] whitespace-pre-wrap">Target Finish Date</p>
          </div>
        </div>
      </div>
      <Frame17 />
    ...
    <div className="bg-white h-[48px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
          <div className="overflow-clip relative shrink-0 size-[20px]" data-name="notes">
            <div className="absolute inset-[12.5%_20.83%]" data-name="Vector">
              <div className="absolute inset-[-5%_-6.43%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.1667 16.5">
                  <path d={svgPaths.p26bf6880} id="Vector" stroke="var(--stroke-0, #016699)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                </svg>
              </div>
            </div>
          </div>
        ...
        <div className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
          <div className="overflow-clip relative shrink-0 size-[20px]" data-name="notes">
            <div className="absolute inset-[12.5%_20.83%]" data-name="Vector">
              <div className="absolute inset-[-5%_-6.43%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.1667 16.5">
                  <path d={svgPaths.p26bf6880} id="Vector" stroke="var(--stroke-0, #ADB5BD)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                </svg>
              </div>
            </div>
          </div>
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[141px]">
      <div className="bg-[#f8f9fa] relative shrink-0 w-full" data-name="Title cell">
        <div aria-hidden="true" className="absolute border-[#dee2e6] border-b border-solid inset-[0_0_-0.5px_0] pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[12px] items-center justify-center px-[12px] py-[8px] relative w-full">
            <p className="flex-[1_0_0] font-['Avenir:Heavy',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#495057] text-[14px] whitespace-pre-wrap">Monitoring Notes</p>
          </div>
        </div>
      </div>
      <Frame21 />
...
function Frame18() {
  return (
    <div className="bg-white h-[48px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
          <button className="content-stretch cursor-pointer flex gap-[12px] items-center relative shrink-0" data-name="Checkbox">
            <Box />
          </button>
        </div>
      </div>
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[114px]">
      <div className="bg-[#f8f9fa] relative shrink-0 w-full" data-name="Title cell">
        <div aria-hidden="true" className="absolute border-[#dee2e6] border-b border-solid inset-[0_0_-0.5px_0] pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[12px] items-center justify-center px-[12px] py-[8px] relative w-full">
            <p className="flex-[1_0_0] font-['Avenir:Heavy',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#495057] text-[14px] whitespace-pre-wrap">Completion</p>
          </div>
        </div>
      </div>
      <Frame18 />
