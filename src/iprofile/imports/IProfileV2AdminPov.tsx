import svgPaths from "./svg-ocnhxr4zas";
...
function Frame151() {
  return (
    <div className="absolute h-[285.931px] left-[18px] overflow-clip rounded-bl-[8px] rounded-br-[164.89px] rounded-tl-[8px] rounded-tr-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] top-[99px] w-[268.832px]">
      <div className="-translate-x-1/2 absolute bg-[#197fc9] bottom-[-0.07px] h-[214px] left-[calc(50%+0.08px)] rounded-[8px] w-[269px]" />
      <div className="-translate-x-1/2 absolute h-[286px] left-[calc(50%+0.08px)] top-0 w-[269px]" data-name="image 96">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[134.19%] left-[-0.13%] max-w-none top-[-17.13%] w-[100.16%]" src={imgImage96} />
        </div>
      </div>
      <div className="absolute bg-gradient-to-b bottom-[-0.07px] from-[rgba(0,0,0,0)] h-[162px] left-0 to-[rgba(0,0,0,0.8)] w-[269px]" />
      <div className="absolute content-stretch flex items-start left-[19px] top-[249px]" data-name="Chip - DISC">
        <div className="bg-[#e7f5ff] content-stretch flex gap-[4px] items-center justify-center px-[8px] py-[2px] relative rounded-[800px] shrink-0" data-name="Chip">
          <div className="overflow-clip relative shrink-0 size-[14px]" data-name="star">
            <div className="absolute inset-[8.34%_8.42%_12.52%_8.36%]" data-name="Vector">
              <div className="absolute inset-[-6.77%_-6.44%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.1504 12.5793">
                  <path d={svgPaths.p3a516900} id="Vector" stroke="var(--stroke-0, #016699)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                </svg>
              </div>
            </div>
          </div>
...
function Frame88() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-end left-[217px] top-[202.83px] w-[135px]">
      <Frame26 />
      <Frame102 />
      <Frame25 />
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[4px] h-[18px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#495057] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">Chief Marketing Officer</p>
      </div>
...
function Frame118() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative">
      <div className="bg-white h-[405px] overflow-clip relative rounded-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Profile">
        <Frame151 />
        <Frame78 />
      ...
      <div className="bg-white relative rounded-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Score Aspect">
        <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[12px] items-center p-[16px] relative w-full">
            <Frame79 />
            <Frame75 />
            <Frame153 />
            <Frame116 />
...
function Frame49() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[313px]" data-name="Component successors">
...
function Group() {
  return (
    <div className="absolute h-[372px] left-[17.66px] top-[343px] w-[16.586px]">
      <div className="absolute inset-[-0.99%_0_-0.13%_-3.01%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.0859 376.182">
          <g id="Group 3638">
            <path d={svgPaths.p360fda80} fill="var(--stroke-0, #495057)" id="Vector 749" />
            <path d="M0.5 222.682V375.682H16.5" id="Line 114" stroke="var(--stroke-0, #2F95DE)" strokeDasharray="2 2" />
            <line id="Line 115" stroke="var(--stroke-0, #495057)" strokeLinecap="square" x1="1.58594" x2="16.5859" y1="69.182" y2="69.182" />
            <line id="Line 116" stroke="var(--stroke-0, #495057)" strokeLinecap="square" x1="1.58594" x2="16.5859" y1="144.182" y2="144.182" />
            <line id="Line 117" stroke="var(--stroke-0, #2F95DE)" strokeDasharray="2 2" strokeLinecap="square" x1="1.58594" x2="16.5859" y1="298.182" y2="298.182" />
          </g>
        </svg>
      </div>
    </div>
...
function Group1() {
  return (
    <div className="absolute h-[242px] left-[17.66px] top-[93px] w-[16.586px]">
      <div className="absolute inset-[-1.52%_0_-0.21%_-3.01%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.0859 246.182">
          <g id="Group 3639">
            <path d={svgPaths.p2c9ddfc0} fill="var(--stroke-0, #495057)" id="Vector 749" />
            <line id="Line 115" stroke="var(--stroke-0, #2F95DE)" strokeDasharray="2 2" strokeLinecap="square" x1="1.58594" x2="16.5859" y1="161.182" y2="161.182" />
            <line id="Line 116" stroke="var(--stroke-0, #2F95DE)" strokeDasharray="2 2" strokeLinecap="square" x1="1.58594" x2="16.5859" y1="82.182" y2="82.182" />
          </g>
        </svg>
      </div>
    </div>
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-[0] px-[16px] py-[4px] relative size-full whitespace-nowrap">
          <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center not-italic relative shrink-0 text-[#016699] text-[14px]">
            <p className="leading-[normal]">Rising Project Team</p>
          </div>
  ...
  return (
    <div className="bg-[#f8f9fa] flex-[1_0_0] h-[51.5px] min-h-px min-w-px relative rounded-[8px]" data-name="Component 130">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center leading-[0] px-[16px] py-[4px] relative size-full whitespace-nowrap">
          <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center not-italic relative shrink-0 text-[#016699] text-[14px]">
            <p className="leading-[normal]">Pegasus Team</p>
          </div>
          <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#495057] text-[10px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[normal]">{`as  Team member`}</p>
          </div>
...
function Frame121() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative">
      <div className="bg-white relative rounded-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Career & Succession plan">
        <div className="flex flex-col items-end overflow-x-clip overflow-y-auto size-full">
          <div className="content-stretch flex flex-col gap-[16px] items-end pl-[36px] pr-[16px] py-[16px] relative w-full">
            <Frame80 />
            <Frame47 />
      ...
      <div className="bg-white relative rounded-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Teams">
        <div className="content-stretch flex flex-col gap-[23px] items-start p-[16px] relative w-full">
          <Frame117 />
          <Frame87 />
          <div className="absolute left-0 overflow-clip size-[16px] top-[17px]" data-name="grip-vertical">
            <div className="absolute inset-[16.67%_33.33%]" data-name="Vector">
      ...
      <div className="bg-white h-[216.313px] relative rounded-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Data Extension">
        <div className="content-stretch flex flex-col gap-[23px] items-start p-[16px] relative size-full">
          <Frame91 />
          <Frame94 />
          <div className="absolute left-0 overflow-clip size-[16px] top-[16px]" data-name="grip-vertical">
            <div className="absolute inset-[16.67%_33.33%]" data-name="Vector">
...
function IdpList() {
  return (
    <div className="bg-[#f8f9fa] content-stretch flex flex-col gap-[12px] items-start p-[16px] relative rounded-[8px] shrink-0 w-[336.333px]" data-name="IDP List">
      <Frame146 />
      <Frame106 />
      <Frame107 />
      <div className="content-stretch flex items-start relative shrink-0" data-name="Chip - DISC">
...
function Frame119() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative">
      <div className="bg-white relative rounded-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="IDP List">
      ...
      <div className="bg-white relative rounded-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Employee Data">
...
function Frame120() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[945px] items-start left-[57px] top-[54px] w-[1340px]">
      <Frame118 />
      <Frame121 />
      <Frame119 />
    </div>
...
function Heading() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[50px] top-[15px] w-[1345px]" data-name="Heading">
      <div className="content-stretch flex gap-[5px] items-center relative shrink-0" data-name="Breadcrumbs">
        <div className="flex items-center justify-center relative shrink-0">
          <div className="-scale-y-100 flex-none">
            <div className="overflow-clip relative size-[24px]" data-name="chevron-left">
              <div className="absolute bottom-1/4 left-[37.5%] right-[37.5%] top-1/4" data-name="Vector">
                <div className="absolute inset-[-6.25%_-12.5%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.5 13.5">
                    <path d={svgPaths.p3a568e10} id="Vector" stroke="var(--stroke-0, #58595B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                  </svg>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#016699] text-[12px] whitespace-nowrap">
          <p className="leading-[normal]">List Employee</p>
        </div>
        ...
        <div className="flex flex-col font-['Avenir:Heavy',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#58595b] text-[12px] whitespace-nowrap">
          <p className="leading-[normal]">Employee Profile</p>
        </div>
      </div>
      <div className="relative shrink-0 size-[24px]" data-name="Notif">
          ...
          <div className="absolute inset-[12.5%_16.67%]" data-name="Vector">
            <div className="absolute inset-[-4.17%_-4.69%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5001 19.5">
                <path d={svgPaths.p265e6d00} id="Vector" stroke="var(--stroke-0, #58595B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              </svg>
            </div>
          </div>
        </div>
        <div className="absolute bottom-1/2 left-[54.17%] right-[4.17%] top-[8.33%]">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
            <circle cx="5" cy="5" fill="var(--fill-0, #DE350B)" id="Ellipse 44" r="5" />
          </svg>
        </div>
      </div>
    </div>
...
function TopHeading() {
  return (
    <div className="absolute bg-[#f8f9fa] h-[54px] left-0 overflow-clip top-0 w-[1440px]" data-name="Top Heading">
      <Heading />
    </div>
  );
}

export default function IProfileV2AdminPov() {
  return (
    <div className="bg-[#f8f9fa] relative size-full" data-name="iProfile v2 - Admin POV">
      <Frame120 />
      <TopHeading />
    </div>
  );
