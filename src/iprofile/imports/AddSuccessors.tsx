import svgPaths from "./svg-hkd01x58jv";
...
const imgDimasEka = "/iprofile-assets/84b5b4f0e9f1f333995c141185978499ae4ec872.png";
...
function Frame({ onClose }: { onClose?: () => void }) {
  return (
    <div className="content-stretch flex h-[22px] items-center justify-between relative shrink-0 w-full">
      <p className="font-['Open_Sans',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#58595b] text-[16px]">Add Successors for Ignatius</p>
      <button className="block cursor-pointer overflow-clip relative shrink-0 size-[20px] hover:opacity-70 transition-opacity" data-name="x" onClick={onClose}>
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[8px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px overflow-hidden relative text-[#adb5bd] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[normal] overflow-hidden">Search by name or position...</p>
          </div>
...
function Frame50() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[500px] items-start overflow-x-clip overflow-y-auto relative shrink-0 w-full [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-300/40 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:hover:bg-gray-400/50">
      <Frame20 />
      <Frame44 />
      <Frame43 />
      <Frame42 />
