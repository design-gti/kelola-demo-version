...
// The manager's 6 direct team members
export const MANAGER_TEAM_IDS = ["c1", "c2", "c4", "c5", "c6", "c8"];
...
export const managerMappingCells = [
  { count: 1, label: "Need Coaching",    countColor: "#bfd6ff",             bg: "#e8f1ff", avatars: [] as string[], names: ["Rizky Pratama"] },
  { count: 2, label: "Rising Star",      countColor: "#9abdfd",             bg: "#b1cfff", avatars: [] as string[], names: ["Budi Santoso", "Nurul Hidayah"] },
  { count: 1, label: "Star",             countColor: "#689eff",             bg: "#83b4ff", avatars: [] as string[], names: ["Siti Rahayu"] },
  { count: 0, label: "Questionable Fit", countColor: "rgba(222,53,11,0.2)", bg: "#ffe4e4", avatars: [] as string[], names: [] },
  { count: 2, label: "Contributor",      countColor: "#bfd6ff",             bg: "#e8f1ff", avatars: [] as string[], names: ["Dewi Kusuma", "Maya Sari"] },
